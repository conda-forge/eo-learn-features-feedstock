...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eo-learn-features-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8654&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eo-learn-features-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eo-learn-features` can be installed with:

```
conda install eo-learn-features
```

It is possible to list all of the versions of `eo-learn-features` available on your platform with:
